...
var categoryController = {
    ...
    registerEvent: function () {
        $('#frmAddNew').validate({
            ...
            messages: {
                Name: {
                    required: "Yêu cầu nhập tên danh mục sách",
        ...
        $('#btnAdd').off('click').on('click', function () {
            if ($('#frmAddNew').valid()) {
                ...
                categoryController.checkExist(name);
            }
        });
