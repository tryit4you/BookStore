...
var courseScripts = {
    Init: function () {
        courseScripts.loadData();
        courseScripts.registerEvent();
    },
    registerEvent: function () {
        $('.btn-search').off('click').on('click', function () {
            courseScripts.loadData(true);
        });
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    $.each(data, function (i, item) {
                        var url = "/khoa-hoc/" + item.metaName + "/" + item.id + "/";
                    ...
                    courseScripts.paging(response.total, response.page, function () {
                        courseScripts.loadData();
                    }, changePageSize);
                }
            }
